...
def get_date_time(data):
    ...
    data['tot_ts_2'] = dt.datetime.combine(dt.datetime.date(data['ts_date_val']), dt.datetime.time(data['ts_time_val']))
    # --------------------------------------------------------
    # if data['os'] != 'linux':
    ...
    # --------------------------------------------------------
    data['tot_ts']  = data['tot_ts_2'].strftime("%Y-%b-%d, %I:%M:%S (%p)")      
    data['disp_ts'] = data['tot_ts']
        
    t2 = dt.datetime.utcnow()    
        
    data['time_diff'] = (t2 - data['tot_ts_2']).total_seconds()
