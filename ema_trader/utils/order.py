...
def make_order(data):
    if not data['open_order']:
        if data['position'] == 'above' and data['angle'] > data['sema_make_order_angle']:
        ...
        elif data['position'] == 'below' and data['angle'] < -data['sema_make_order_angle']:
...
def close_order(data):
    if data['open_order']:
        if data['position'] == 'below' and data['open_order_type'] == 'long' and data['angle'] < -data['sema_close_order_angle']:
        ...
        elif data['position'] == 'above' and data['open_order_type'] == 'short' and data['angle'] > data['sema_close_order_angle']:
